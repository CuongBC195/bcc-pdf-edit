...
import { Archive, Save, Check, CheckCircle2, AlertTriangle, Loader2 } from 'lucide-react';
...
export const ExportActionBar: React.FC<ExportActionBarProps> = ({
  ...
  // If there are 0 valid rules and no ongoing export process, DO NOT render the bar at all
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.76rem', color: 'var(--text-dim)', marginTop: '4px' }}>
      ...
      {isBusy && (
        <div style={{ flex: 1, maxWidth: '360px', margin: '0 16px', minWidth: '200px' }}>
